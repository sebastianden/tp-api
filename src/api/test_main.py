...
def test_users_endpoint(mock_get_db, client, mock_db):
...
@patch("main.get_db_connection")
def test_businesses_endpoint(mock_get_db, client, mock_db):
...
@patch("main.get_db_connection")
def test_reviews_endpoint(mock_get_db, client, mock_db):
...
def test_csv_response_with_data():
